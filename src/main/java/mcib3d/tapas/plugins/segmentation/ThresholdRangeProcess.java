...
public class ThresholdRangeProcess implements TapasProcessing {
    ...
    public ImagePlus execute(ImagePlus input) {
        ...
        thresholdMin = Float.parseFloat(TapasBatchProcess.getKey(thresholdS, info, users));
        thresholdS = parameters.get(THRESHOLD_MAX);
        thresholdMax = Float.parseFloat(TapasBatchProcess.getKey(thresholdS, info, users));
