...
public class NormaliseValuesProcess implements TapasProcessingIJ {
    ...
    public ImagePlus execute(ImagePlus input) {
        // mean and sd
        float mean = Float.parseFloat(TapasBatchUtils.getKey(getParameter(MEAN), info, "-"));
        float sd = Float.parseFloat(TapasBatchUtils.getKey(getParameter(SD), info, "-"));
